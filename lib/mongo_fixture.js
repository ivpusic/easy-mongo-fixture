...
function constructExportCommand(obj, opts) {
...
function runCommands(ctx) {
  ...
  commands = ctx.collections.map(function (collection) {
    ...
    // promise with mongoexport command and coresponging arguments
    return Q.nfcall(exec, constructExportCommand(ctx.config, {
      dir: ctx.dir,
